...
GuiScrollbar::GuiScrollbar(int h, u8 m)
{
	...
	scrollbarTop = App.Resources.GetImageData("scrollBarTop.png");
	scrollbarBottom = App.Resources.GetImageData("scrollBarBottom.png");
	scrollbarTile = App.Resources.GetImageData("scrollBarTile.png");
	arrowDown = App.Resources.GetImageData("scrollbar_arrowdown.png");
	arrowDownOver = App.Resources.GetImageData("scrollbar_arrowdown.png");
	arrowUp = App.Resources.GetImageData("scrollbar_arrowup.png");
	arrowUpOver = App.Resources.GetImageData("scrollbar_arrowup.png");
	scrollbarBox = App.Resources.GetImageData("scrollbar_box.png");
	scrollbarBoxOver = App.Resources.GetImageData("scrollbar_box.png");
	oneButtonScrollImgData = App.Resources.GetImageData("oneButtonScroll.png");
...
void GuiScrollbar::OnBoxButtonHold(GuiButton *sender, int pointer, const POINT &p)
{
	...
	if (!Input::GetUserInput(pointer)->wpad.ir.valid)
		return;
...
void GuiScrollbar::Draw()
{
	...
	if (pressedChan >= 0 && Input::GetUserInput(pressedChan)->wpad.ir.valid)
