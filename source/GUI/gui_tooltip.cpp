...
{
	tooltipLeft = App.Resources.GetImageData("tooltip_left.png");
	tooltipTile = App.Resources.GetImageData("tooltip_tile.png");
	tooltipRight = App.Resources.GetImageData("tooltip_right.png");
